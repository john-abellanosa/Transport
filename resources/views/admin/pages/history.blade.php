...
@section('content')
    ...
    <head>
        ...
        <title>@yield('title', 'Admin Panel - Records')</title>
        <link rel="stylesheet" href="{{ asset('css/admin/pages/history/history.css') }}">
        <link rel="stylesheet" href="{{ asset('css/admin/pages/history/view-modal.css') }}">
    ...
    <body>
        ...
        <div class="admin-history-wrapper">
            <div class="table-container">
                ...
                <div class="history-table-scroll">
                        ...
                        <tbody>
                            @foreach ($histories as $trip)
                                <tr data-trip-id="{{ $trip->id }}" data-trip='{!! json_encode([
                                    ...
                                    <td class="actions">
                                        <button class="view" title="View" type="button"><i
                    ...
                    <div id="noData" class="no-data">
                        <img src="{{ asset('img/no-data.png') }}" alt="No History">
...
@vite(['resources/js/admin/pages/history/view-modal.js'])  
