...
@section('title', 'Driver Panel - Dashboard')
...
@section('content')
    ...
    <head>
        ...
        <title>@yield('title', 'Driver Panel - Dashboard')</title>
        <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700&display=swap">
        <link href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined" rel="stylesheet" />
        <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
        <link rel="stylesheet" href="{{ asset('css/admin/pages/alert.css') }}">
        <link rel="stylesheet" href="{{ asset('css/driver/pages/dashboard.css') }}">
    </head>
...
@vite(['resources/js/driver/pages/dashboard.js'])
