...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/driver/auth/verify-otp.css') }}">
...
<body>
    ...
    <div class="container">
        <div class="left">
            <img src="{{ asset('img/driver.jpg') }}" alt="Driver Image">
        </div>
            ...
            <div class="right-side">
                ...
                <div class="login-form">
                    ...
                    <form action="{{ route('driver.verifyOtp.submit') }}" method="POST" id="otpForm">
                        ...
                        <div class="otp-box">
                            @for ($i = 0; $i < 6; $i++)
                                <input type="text" maxlength="1" required inputmode="numeric" pattern="[0-9]*" class="otp-field">
                            @endfor
                        </div>
    ...
    <script>
        ...
        resendForm.action = "{{ route('driver.resendOtp') }}";
        ...
        // ✅ Reuse alert pop-up for invalid OTP or expired OTP
        document.addEventListener('DOMContentLoaded', () => {
            const errorAlert = document.getElementById('error-alert');
            if (errorAlert) {
                const message = errorAlert.innerText.replace('Error:', '').trim();
            ...
            if (successAlert) {
                const message = successAlert.innerText.replace('Success:', '').trim();
