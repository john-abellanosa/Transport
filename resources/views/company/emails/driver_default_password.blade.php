...
<body>
    ...
    <div class="preheader">Your driver account was created. Here are your credentials and login link.</div>
                ...
                <table role="presentation" class="container" cellspacing="0" cellpadding="0" width="100%">
                    ...
                    <tr>
                        <td class="content">
                            ...
                            <p style="margin-top: 14px;">Please sign in and change your password immediately to keep
                                your account secure.</p>

                            <div class="cta">
                                @php $loginUrl = $loginUrl ?? url('/driver/login'); @endphp
                                <a href="{{ $loginUrl }}" class="btn" target="_blank" rel="noopener">Sign in</a>
                            </div>

                            <p class="note">
                                If the button doesn't work, copy and paste this link into your browser:<br>
                                <a href="{{ $loginUrl }}" style="color:#1772BA; text-decoration: underline;"
                                    target="_blank" rel="noopener">{{ $loginUrl }}</a>
                            </p>
                        </td>
                    </tr>
                    <tr>
