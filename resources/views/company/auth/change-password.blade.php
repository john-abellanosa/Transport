...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/company/auth/change-password.css') }}">
            ...
            <div class="right-side">
                ...
                <div class="change-form">
                    ...
                    <p class="welcome-desc">
                        Create a strong and secure password to protect your company account.
                    </p>

                    <form method="POST" action="{{ route('company.updatePassword') }}" id="passwordForm">
                        @csrf
                        ...
                        <a href="{{ route('company.backLogin') }}" class="back-link">Back to Login</a>
                    </form>
                </div>
            </div>
        </div>
...
@vite(['resources/js/company/auth/change-password.js'])
